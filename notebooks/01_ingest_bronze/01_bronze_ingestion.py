...
from quant_core.ingestion.runtime import run_bronze_ingestion
...
run_bronze_ingestion(spark=spark, target_yyyymm=TARGET_YYYYMM, catalog=CATALOG, landing_base=LANDING_BASE)
